...
@CellFormatter(Integer.class)
public class IntegerCellFormatter implements CellValueFormatter<Integer> {
    // private static final Logger logger = Logger.getLogger(IntegerCellFormatter.class);
    // public static final Log logger = LogFactory.getLog(IntegerCellFormatter.class);
