...
public abstract class ClasspathHelper {
   ...
   * For example, {@code forPackage(org.rapidpm.module.se.commons.reflections)} effectively returns URLs from the
   * classpath containing packages starting with {@code org.rapidpm.module.se.commons.reflections}.
   * <p>
   ...
   * <p>
   * This finds the URLs using {@link java.net.URLClassLoader#getURLs()} using both
   ...
   * Returns a distinct collection of URLs based on URLs derived from class loaders.
   * <p>
   * This finds the URLs using {@link java.net.URLClassLoader#getURLs()} using the specified
   ...
   * <p>
   * This finds the URLs using the {@link javax.servlet.ServletContext}.
   * <p>
   * The returned URLs retains the order of the given {@code classLoaders}.
   *
   * @return the collection of URLs, not null
