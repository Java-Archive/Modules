...
package gui.org.rapidpm.modul.javafx.searchbox;

import javax.inject.Inject;

import gui.org.rapidpm.modul.javafx.searchbox.demo.DemoDataBuilder;
import gui.org.rapidpm.modul.javafx.searchbox.demo.SearchBoxDemoPane;
import gui.org.rapidpm.modul.javafx.searchbox.demo.SearchBoxDemoPaneController;
import gui.org.rapidpm.modul.javafx.searchbox.demo.model.TransientDemoDataRow;
...
public class SearchBoxTest extends JavaFXBaseTest {
    ...
    public static class TestImpl extends JavaFXBaseTest.JavaFXBaseTestImpl {
        ...
        @Inject
        SearchBoxDemoPane root;
        @Inject
        DemoDataBuilder dataBuilder;
