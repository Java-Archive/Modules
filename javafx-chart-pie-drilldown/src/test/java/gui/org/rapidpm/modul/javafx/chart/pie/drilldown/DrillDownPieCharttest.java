...
public class DrillDownPieChartTest extends JavaFXBaseTest {
    ...
    public static class TestImpl extends JavaFXBaseTest.JavaFXBaseTestImpl {
        ...
        @Inject DrillDownPieChartPane root;
        ...
        @Override public void testImpl(Stage stage) {
            ...
            final DrillDownPieChartPaneController controller = root.getController();
            final ObservableList<TransientDemoDataRow> transientDemoDataRows = dataBuilder.create();

            controller.getPiechart().setDataValueList(transientDemoDataRows);
            stage.show();
            controller.init();
