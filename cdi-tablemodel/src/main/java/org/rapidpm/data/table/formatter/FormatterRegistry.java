...
public class FormatterRegistry extends AbstractRegistry<CellFormatter, CellValueFormatter> {
    public FormatterRegistry() {
        super(CellFormatter.class);
    }

    @Override
    protected Class<?> getClass(final CellFormatter cellFormatter) {
