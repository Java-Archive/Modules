...
import org.rapidpm.modul.javafx.tableview.filtered.operators.operation.DefaultDoubleOperation;
 ...
 * Time: 18:19
 */
public abstract class DoubleFilter<T> extends FilteredTableViewIterator<T, Double> {

    public DoubleFilter(FilteredTableView tableView) {
        super(tableView);
    }
    ...
    @Override public Operation getDefaultOperation() {
        return new DefaultDoubleOperation();
    }
}
